                        ...
                        <div class="col-lg-12 col-12">
                            <div class="job-thumb d-flex">
                                <div class="job-image-wrap bg-white shadow-lg">
                                    <img src="{{ asset('page/images/logos/google.png') }}" class="job-image img-fluid" alt="">
                                </div>
                            ...
                            <div class="job-thumb d-flex">
                                <div class="job-image-wrap bg-white shadow-lg">
                                    <img src="{{ asset('page/images/logos/apple.png') }}" class="job-image img-fluid" alt="">
                                </div>
                            ...
                            <div class="job-thumb d-flex">
                                <div class="job-image-wrap bg-white shadow-lg">
                                    <img src="{{ asset('page/images/logos/meta.png') }}" class="job-image img-fluid" alt="">
                                </div>
                            ...
                            <div class="job-thumb d-flex">
                                <div class="job-image-wrap bg-white shadow-lg">
                                    <img src="{{ asset('page/images/logos/slack.png') }}" class="job-image img-fluid" alt="">
                                </div>
                            ...
                            <div class="job-thumb d-flex">
                                <div class="job-image-wrap bg-white shadow-lg">
                                    <img src="{{ asset('page/images/logos/creative-market.png') }}" class="job-image img-fluid" alt="">
                                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{ asset('page/images/logos/twitter.png') }}" class="job-image me-3 img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src="{{ asset('page/images/jobs/pretty-blogger-posing-cozy-apartment.jpg') }}" class="job-image img-fluid" alt="">
                                    </a>
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{ asset('page/images/logos/yelp.png') }}" class="job-image me-3 img-fluid" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                <div class="job-image-box-wrap">
                                    <a href="job-details.html">
                                        <img src="{{ asset('page/images/jobs/paper-analysis.jpg') }}" class="job-image img-fluid" alt="">
                                    </a>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="job-thumb job-thumb-box">
                                ...
                                <div class="job-body">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                            <img src="{{ asset('page/images/logos/envato.png') }}" class="job-image me-3 img-fluid" alt="">
