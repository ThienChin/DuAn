...
<<<<<<< HEAD
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-light" aria-labelledby="navbarLightDropdownMenuLink">
                                <li><a class="dropdown-item" href="{{ route('jobs.index') }}">Job Listings</a></li> <!-- Sửa từ page.list thành jobs.index -->
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-3 col-6 ms-lg-auto">
                    ...
                    <ul class="footer-menu">
                        ...
                        <li class="footer-menu-item"><a href="{{ route('emails.contact') }}" class="footer-menu-link">Contact</a></li> <!-- Sửa từ emails.contact thành route đúng -->
                    </ul>
                </div>
